...
Here the `payment_request` is presented along with its associated QR code.
...
<img src="invoicePaid.png" alt="drawing" width="800" class="center" border="5" style="border:5px double black"/>
